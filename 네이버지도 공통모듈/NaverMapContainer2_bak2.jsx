...
const NaverMapContainer = (props) => {
    ...
    },[props.mapConf.minMaxEvt?.x, props.mapConf.minMaxEvt?.y])
    ...
    useEffect(() => {
        if(props.mapConf.minMaxEvt !== undefined){
            navermaps.Event.addListener(map.current, 'dragend', function(e){
                // getPolyLineMarkerMinMax();
                console.log(e);
                props.mapConf.minMaxEvt.x = e.coord.x;
                props.mapConf.minMaxEvt.y = e.coord.y;
                console.log(props.mapConf.minMaxEvt);
    ...
    useEffect(() => {
        ...
        if(viewDatalist !== undefined && viewDatalist.length > 0){
            ...
            props.mapConf.minMaxEvt.x = lon;
            props.mapConf.minMaxEvt.y = lat;
